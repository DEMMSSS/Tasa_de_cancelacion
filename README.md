...
# Objetivos
Realizar una exploración inicial de los datos y, en base a esto, preprocesarlos hasta que no se registren valores ausentes, duplicados o artefactos extraños.
Investigar y encontrar patrones en los datos a través un análisis exploratorio univariado y bivariado.
...
Escoger aquel modelo que alcance un AUC-ROC de al menos 0.88 en el conjunto de prueba.
